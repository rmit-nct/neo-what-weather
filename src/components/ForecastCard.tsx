...
const ForecastCard = ({ forecast, className = "" }: ForecastCardProps) => {
  ...
  return (
    <div className={` ${className}`}>
      ...
      <div className="px-3 space-y-2 weather-card weather-card-hover pb-6 ">
        {dailyForecast.map((day, index) => {
          ...
          return (
            <div
              key={day.dt}
              className="grid grid-cols-[auto_1fr_auto] items-center  border-b border-weather-border last:border-b-0 py-1 mr-2 my-2 overflow-y-auto"
            >
          ...
          {dailyForecast.length > 1 && (
            <div className="mt-6 pt-6 border-weather-border ">
